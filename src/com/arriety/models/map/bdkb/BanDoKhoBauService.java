    ...
    public void updatePlayer(Player player) {
        ...
        try {
            if (player.clan != null && player.clan.banDoKhoBau != null) {
                ...
                if (!(now >= player.clan.banDoKhoBau_lastTimeOpen
                        && now <= (player.clan.banDoKhoBau_lastTimeOpen + BanDoKhoBau.TIME_BAN_DO_KHO_BAU))) {
                    ketthucbdkb(player);
                } else if (player.clan.banDoKhoBau.timePickReward
                        && (System.currentTimeMillis() - player.clan.banDoKhoBau.getLastTimeOpen() > 2000)) {
                    ketthucbdkb(player);
                }
            }
