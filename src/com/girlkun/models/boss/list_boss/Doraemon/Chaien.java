...
public class Chaien extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(15, 100)) {
            if (Util.isTrue(1, 50)) {
                Service.gI().dropItemMap(this.zone, Util.ratiItem(zone, 457, 100, this.location.x, this.location.y, plKill.id));
                return;
            }
            Service.gI().dropItemMap(this.zone, Util.ratiItem(zone, itemDos[randomDo], 100, this.location.x, this.location.y, plKill.id));
