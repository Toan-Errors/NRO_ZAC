                            ...
                            switch (select) {
                                ...
                                case 2:
                                    CombineServiceNew.gI().openTabCombine(player,
                                            CombineServiceNew.MO_CHI_SO_Chien_Linh);
                                    break;
                            }
                    ...
                    switch (select) {
                        case 0:
                            Service.gI().sendThongBaoOK(pl,
                                    "Cửa hàng chuyên nhận ký gửi mua bán vật phẩm\bChỉ với 20 thỏi vàng\bGiá trị ký gửi 10 - 10000 thỏi vàng\bMột người bán, vạn người mua, mại dô, mại dô");
                            break;
                        case 1:
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?",
                                "Giải tán bang hội", "Lãnh địa Bang Hội", "Kho báu dưới biển", "Chuyển sinh");
                    }
                }
            }
                            ...
                            switch (select) {
                                ...
                                case 2:
                                    ...
                                    player.clan.banDoKhoBau_haveGone = !(System.currentTimeMillis()
                                            - player.clan.banDoKhoBau_lastTimeOpen > 300000);
                                    if (player.clan.banDoKhoBau_haveGone) {
                                        createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                                "Bang hội của con đã đi Bản Đồ lúc "
                                                        + TimeUtil.formatTime(player.clan.banDoKhoBau_lastTimeOpen,
                                                                "HH:mm:ss")
                                                        + " hôm nay. Người mở\n"
                                                        + "(" + player.clan.banDoKhoBau_playerOpen
                                                        + "). Hẹn con sau 5 phút nữa",
                                                "OK");
                                        break;
                                    }
                                        ...
                                        createOtherMenu(player, ConstNpc.MENU_OPENED_DBKB,
                                                "Bang hội của con đang tham gia Bản đồ kho báu cấp độ "
                                                        ...
                                                        + TimeUtil.getSecondLeft(
                                                                player.clan.banDoKhoBau.getLastTimeOpen(),
                                ...
                                case 3:
                                    ...
                                    if (player.getSession().player.nPoint.power < 180000000000L) {
                                        ...
                                        Service.gI().sendThongBaoOK(player,
                                                "Còn Thiếu " + (600000 - player.nPoint.hpg) + " HP Nữa");
                                    } else if (player.getSession().player.nPoint.mpg < 600000) {
                                        Service.gI().sendThongBaoOK(player,
                                                "Còn Thiếu " + (600000 - player.nPoint.mpg) + " KI Nữa");
                                    } else if (player.getSession().player.nPoint.dameg < 32000) {
                                        Service.gI().sendThongBaoOK(player,
                                                "Còn Thiếu " + (32000 - player.nPoint.dameg) + " SD Nữa");
                                    } else if (player.getSession().player.inventory.ruby < 20000) {
                                        Service.gI().sendThongBaoOK(player,
                                                "Còn Thiếu " + (20000 - player.inventory.ruby) + " Hồng Ngọc");
                                    } else if (player.getSession().player.nPoint.dameg == 32000) {
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|7|Chào con thầy còn dữ lại " + player.getSession().coinBar
                                        + " Coin của con!\b|2|Tiền mà ít thì nạp lần đầu đi coan :>>"
                        ...
                        switch (select) {
                            ...
                            case 4:
                                if (!player.getSession().actived) {
                                    if (player.getSession().coinBar >= 20) {
                                        player.getSession().actived = true;
                                        if (PlayerDAO.subcoinBar(player, 20)) {
                                            this.npcChat(player, "Đã mở thành viên thành công!");
                                        } else {
                                            this.npcChat(player, "Lỗi vui lòng báo admin...");
                                        }
                                    } else {
                                        this.npcChat(player, "Bạn còn thiếu " + (20 - player.getSession().coinBar)
                                                + " để mở thành viên");
                                    }
                                }
                                break;
                        ...
                        switch (select) {
                            case 2:
                                if (nhanDeTu) {
                                    if (player.pet == null) {
                                        PetService.gI().createNormalPet(player);
                                        Service.gI().sendThongBao(player, "Bạn vừa nhận được trẻ trâu hãy nuôi nó");
                                    } else {
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_HN,
                                            "Hãy chọn mệnh giá muốn thay đổi.", "10k",
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (player.getSession().coinBar >= coin) {
                                        ...
                                        Item dns = ItemService.gI().createNewItem((short) 861, dans);// x3
                    ...
                    if (this.mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 2:
                                    CombineServiceNew.gI().openTabCombine(player,
                                            CombineServiceNew.NANG_CAP_DO_KICH_HOAT);
                                    break;
                                case 3:
                        ...
                        switch (select) {
                            ...
                            case 1:
                                if (player.nPoint.power < 80000000000L) {
                                    Service.getInstance().sendThongBao(player, " Bạn tuổi lon mà đòi qua map!");
                                    return;
                                } else if (player.inventory.ruby < 500) {
                                    Service.getInstance().sendThongBao(player,
                                            "Phí vào là 500 hồng ngọc một lần bạn ey!\nBạn đéo đủ!");
                                    return;
                                } else {
                            ...
                            switch (select) {
                                ...
                                case 2: {
                                    try {
                                        ...
                                        // java.util.logging.Logger.getLogger(NpcFactory.class.getName()).log(Level.SEVERE,
                                        // null, ex);
                                    }
                                }
                                    break;
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    ...
                                    break;
//                               case 1:
//                                    this.npcChat(player, "Chức Năng Đang Bảo Trì!"); // bảo trì thì bật cái này tắt cái
                                                                                     // dưới
//                                    break;
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            switch (select) {
                                ...
                                case 2:
                                    ...
                                    // + "\n"
                                    // + "Thời gian còn lại là "
                                    // + TimeUtil.getSecondLeft(player.clan.khigas.getLastTimeOpen(),
                                    // KhiGas.TIME_KHI_GAS / 1000)
                    ...
                    switch (player.iDMark.getIndexMenu()) {
                        case ConstNpc.BASE_MENU:
                            switch (select) {
                                ...
                                case 2:
                                    Service.gI().sendThongBaoOK(player,
                                            "Điểm Khí Gas Của Bạn: " + player.khigas + "Quá Gke :>>");
                                    break;
                                case 3:
                                    if (player.clan == null) {
                                        this.createOtherMenu(player, ConstNpc.IGNORE_MENU,
    ...
    public static Npc nhacai(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (player.rubyWin > 0) {
                        createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Chẵn lẻ đê.\n Bạn đã thắng được "
                                        + Util.numberToMoney((int) (player.rubyWin * pariryManager.tiLe))
                                        + " thỏi vàng\n",
                                "Chẵn", "Lẻ", "Xem \nlịch sử\nbản thân", "Xem \nlịch sử",
                                "Nhận\nphần thưởng");
                    } else {
                            ...
                            switch (select) {
                                ...
                                case 0:
                                    if (!PariryServices.gI().checkHavePariry()) {
                                        Service.gI().sendThongBao(player, "Chưa có phiên chẵn lẻ nào khởi động");
                                        break;
                                    }
                                ...
                                case 4:
                                    if (player.rubyWin <= 0) {
                                        Service.gI().sendThongBao(player, "Có cái nịt mà nhận");
                                        break;
                                    }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    // } else {
                                    // Service.getInstance().sendThongBao(player, "Bạn không đủ điều kiện tham gia
                                    // giải này, hãy quay lại vào giải phù hợp");
                                    // }
                                    break;
                                case 1:
                                    break;
    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            switch (tempId) {
                ...
                case ConstNpc.NHA_CAI:
                    return nhacai(mapId, status, cx, cy, tempId, avatar);
        ...
        Npc npc = new Npc(-1, -1, -1, -1, ConstNpc.CON_MEO, 351) {
            ...
            public void confirmMenu(Player player, int select) {
                switch (player.iDMark.getIndexMenu()) {
                    ...
                    // else {
                    // Service.gI().sendThongBao(player, "|5|VUI LÒNG KÍCH HOẠT TÀI KHOẢN
                    ...
                    case ConstNpc.UP_TOP_ITEM:
                        ...
                        if (thoivang == null || thoivang.quantity < 20) {
                            ...
                            InventoryServiceNew.gI().sendItemBags(player);
                            int top = ShopKyGuiService.gI().upTopItem(player.iDMark.getIdItemUpTop());
                            Service.getInstance().sendThongBao(player, "Bạn đã đưa vật phẩm lên top " + top);
                            Service.getInstance().sendMoney(player);
                        }
                    ...
                    case ConstNpc.CONFIRM_ACTIVE:
                        switch (select) {
                            case 0:
                                ...
                                Service.gI().sendThongBao(player,
                                        "Bạn không có vàng\n Vui lòng nrozoee.online để nạp thỏi vàng");
                                break;
                        }
                        break;
