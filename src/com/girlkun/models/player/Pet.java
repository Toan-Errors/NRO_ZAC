...
public class Pet extends Player {
    ...
    private static final String[] chatPr = {"T vả chet me m", "Bảo kê cho sư phụ", "Dám đụng vào sư phụ t này", "T cho m chết", "TiMi mãi đỉnh, ai xóa dòng này làm chóa"};
