...
public class Player {
    ...
    private static final short[][] idOutfitFusion = {
            ...
            { 1237, 1238, 1239 }, { 1234, 1235, 1236 }, { 1231, 1232, 1233 },
            { 2057, 2058, 2059 }, { 2060, 2061, 2062 }, { 2054, 2055, 2056 }, };

    private static final short[][] idOutFitSMTiemAn = {
            { 1228, 1229, 1230 }, { 1225, 1226, 1227 }, { 1228, 1229, 1230 }, // tiem nang 1
    };
    ...
    public short getHead() {
        ...
        if (effectSkill != null && itemTime.isdkhi) {
            ...
            return 412;
        } else if (this.itemTime.levelTiemAn != 0 && this.itemTime.isUseSMTiemAn) {
            return idOutFitSMTiemAn[(this.itemTime.levelTiemAn - 1) * 3 + this.gender][0];
        } else {
    ...
    public short getBody() {
        ...
        if (effectSkill != null && itemTime.isdkhi) {
            ...
            return idOutFitSMTiemAn[(this.itemTime.levelTiemAn - 1) * 3 + this.gender][1];
        } else {
            if (fusion != null && fusion.typeFusion != ConstPlayer.NON_FUSION) {
                if (fusion.typeFusion == ConstPlayer.LUONG_LONG_NHAT_THE) {
    ...
    public short getLeg() {
        ...
        if (effectSkill != null && itemTime.isdkhi) {
            ...
            return idOutFitSMTiemAn[(this.itemTime.levelTiemAn - 1) * 3 + this.gender][2];
        } else {
            if (fusion != null && fusion.typeFusion != ConstPlayer.NON_FUSION) {
                if (fusion.typeFusion == ConstPlayer.LUONG_LONG_NHAT_THE) {
    ...
    public int injured(Player plAtt, int damage, boolean piercing, boolean isMobAttack) {
        if (!this.isDie()) {
            ...
            if (plAtt != null) {
                if (isSkillChuong && plAtt.nPoint.multicationChuong > 0
                        && Util.canDoWithTime(plAtt.nPoint.lastTimeMultiChuong, PlayerSkill.TIME_MUTIL_CHUONG)) {
            ...
            if (this.muav && player != null) {
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 1) {
                    ...
                    Service.getInstance().sendThongBao(player,
                            "Bạn phải có ít nhất 2 ô trống hành trang, đã tắt tự mua tv");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
