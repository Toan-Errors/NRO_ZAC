        ...
        if (rs.getBoolean("ban")) {
          ...
          if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
            ...
            if (!rs.first()) {
              ...
              for (int i = 0; i < dataArray.size(); i++) {
                ...
                if (tempId != -1) {
                  ...
                  for (int j = 0; j < options.size(); j++) {
                    ...
                    int id = Integer.parseInt(String.valueOf(opt.get(0)));
              ...
              dataArray = (JSONArray) jv.parse(rs.getString("itemItem"));
              int tuginoMTA = Integer.parseInt(String.valueOf(dataArray.get(0)));

              player.itemTime.lastTimeUseSMTiemAn = System.currentTimeMillis()
                  - (ItemTime.TIME_SUC_MANH - tuginoMTA);

              player.itemTime.isUseSMTiemAn = tuginoMTA != 0;
              if (player.itemTime.isUseSMTiemAn) {
                player.itemTime.levelTiemAn = 1;
              }
              ...
              player.itemTime.lastTimeBoHuyet2 = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - timeBoHuyet2);
              player.itemTime.lastTimeBoKhi2 = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - timeBoKhi2);
              player.itemTime.lastTimeGiapXen2 = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - timeGiapXen2);
              player.itemTime.lastTimeCuongNo2 = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - timeCuongNo2);
              player.itemTime.lastTimeAnDanh2 = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - timeAnDanh2);
              ...
              player.itemTime.lastTimeMaydoCua = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - maydoCua);
              player.itemTime.lastTimeMaydoTom = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - maydoTom);
              player.itemTime.lastTimeMaydoOc = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - maydoOc);
              player.itemTime.lastTimeMaydoCa = System.currentTimeMillis()
                  - (ItemTime.TIME_ITEM - maydoCa);
              ...
              player.itemTime.lastTimedkhi = System.currentTimeMillis()
                  - (ItemTime.TIME_DUOI_KHI - timeduoikhi);
              ...
              if ((new java.sql.Date(player.bdkb_lastTimeJoin))
