...
public class DataGame {
  ...
  public static String LINK_IP_PORT = "Nro ZAC:localhost:14445:0,0,0";
    ...
    for (File f : folder.listFiles()) {
      if (!list.contains(f.getName())) {
        ...
        DataOutputStream dos = new DataOutputStream(
            new FileOutputStream("C:\\Users\\admin\\Desktop\\cbro\\data\\girlkun\\map\\tile_map_data\\" + f.getName()));
        dos.writeByte(w);
        dos.writeByte(h);
        for (int i = 0; i < data.length; i++) {
